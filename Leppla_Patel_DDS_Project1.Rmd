...
Beer$Style[Beer$Name.Beer=="OktoberFiesta"]="Märzen / Oktoberfest"
...
CM_summary %>% ggplot() + geom_line(aes(k,Accuracy,color="Accuracy")) + geom_line(aes(k,Sensitivity,color="Sensitivity")) + geom_line(aes(k,Specificity,color="Specificity")) + geom_vline(xintercept=c(4,5,11)) + ylab("%")
...
CM_summary %>% ggplot() + geom_line(aes(k,Accuracy,color="Accuracy")) + geom_line(aes(k,Sensitivity,color="Sensitivity")) + geom_line(aes(k,Specificity,color="Specificity")) + geom_vline(xintercept=c(4,5,15,37)) + ylab("%")
